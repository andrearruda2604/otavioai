...
export const InteractionItem: React.FC<InteractionItemProps> = ({ 
    initials, name, action, item, time, company, status, statusColor = 'emerald' 
}) => {
    return (
        <div className="flex items-center gap-4 p-3 hover:bg-slate-50 dark:hover:bg-slate-700/50 rounded-xl transition-all cursor-pointer">
