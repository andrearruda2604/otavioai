...
const KanbanColumn: React.FC<KanbanColumnProps> = ({ title, count, color, cards }) => (
    <div className="flex flex-col gap-4">
        ...
        <div className="space-y-4">
            {cards.map((card, i) => (
                <div key={i} className="bg-white dark:bg-card-dark p-5 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 hover:shadow-md transition-shadow relative overflow-hidden group cursor-grab active:cursor-grabbing">
                    ...
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <span className="material-icons-round text-slate-300 text-sm">drag_indicator</span>
                    </div>
        ...
        <main className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-start">
                <KanbanColumn title="Não Encontrado" count={44} color="rose" cards={[
                    { title: "Lanterna Traseira", id: "#1000", date: "09/01/2026", user: "Renata Moura" },
                ...
                <KanbanColumn title="Sem Feedback" count={54} color="amber" cards={[
                    ...
                    { title: "Pastilha de Freio Dianteira", id: "#1004", date: "07/01/2026", user: "Isabela Costa" }
                ]} />
